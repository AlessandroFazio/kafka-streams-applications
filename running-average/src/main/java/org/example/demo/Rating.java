...
public class Rating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1072002319246596714L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Rating\",\"namespace\":\"org.example.demo\",\"fields\":[{\"name\":\"movie_id\",\"type\":\"long\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static org.example.demo.Rating.Builder newBuilder() {
    return new org.example.demo.Rating.Builder();
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static org.example.demo.Rating.Builder newBuilder(org.example.demo.Rating.Builder other) {
    if (other == null) {
      return new org.example.demo.Rating.Builder();
    } else {
      return new org.example.demo.Rating.Builder(other);
    }
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static org.example.demo.Rating.Builder newBuilder(org.example.demo.Rating other) {
    if (other == null) {
      return new org.example.demo.Rating.Builder();
    } else {
      return new org.example.demo.Rating.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rating>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.demo.Rating.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.demo.Rating other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.movie_id)) {
        this.movie_id = data().deepCopy(fields()[0].schema(), other.movie_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.Rating.Builder setMovieId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.Rating.Builder clearMovieId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.Rating.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.Rating.Builder clearRating() {
