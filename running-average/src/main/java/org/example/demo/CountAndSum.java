...
public class CountAndSum extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2400806509699399311L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CountAndSum\",\"namespace\":\"org.example.demo\",\"fields\":[{\"name\":\"count\",\"type\":\"long\"},{\"name\":\"sum\",\"type\":\"double\"}]}");
   ...
   */
  public static org.example.demo.CountAndSum.Builder newBuilder() {
    return new org.example.demo.CountAndSum.Builder();
  }
   ...
   * @return A new CountAndSum RecordBuilder
   */
  public static org.example.demo.CountAndSum.Builder newBuilder(org.example.demo.CountAndSum.Builder other) {
    if (other == null) {
      return new org.example.demo.CountAndSum.Builder();
    } else {
      return new org.example.demo.CountAndSum.Builder(other);
    }
  }
   ...
   * @return A new CountAndSum RecordBuilder
   */
  public static org.example.demo.CountAndSum.Builder newBuilder(org.example.demo.CountAndSum other) {
    if (other == null) {
      return new org.example.demo.CountAndSum.Builder();
    } else {
      return new org.example.demo.CountAndSum.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CountAndSum>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.demo.CountAndSum.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.demo.CountAndSum other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.count)) {
        this.count = data().deepCopy(fields()[0].schema(), other.count);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.CountAndSum.Builder setCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.CountAndSum.Builder clearCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.CountAndSum.Builder setSum(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.demo.CountAndSum.Builder clearSum() {
