...
public class RatedMovie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2063967351173831483L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RatedMovie\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"release_year\",\"type\":\"int\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static org.example.avro.RatedMovie.Builder newBuilder() {
    return new org.example.avro.RatedMovie.Builder();
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static org.example.avro.RatedMovie.Builder newBuilder(org.example.avro.RatedMovie.Builder other) {
    if (other == null) {
      return new org.example.avro.RatedMovie.Builder();
    } else {
      return new org.example.avro.RatedMovie.Builder(other);
    }
  }
   ...
   * @return A new RatedMovie RecordBuilder
   */
  public static org.example.avro.RatedMovie.Builder newBuilder(org.example.avro.RatedMovie other) {
    if (other == null) {
      return new org.example.avro.RatedMovie.Builder();
    } else {
      return new org.example.avro.RatedMovie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RatedMovie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.RatedMovie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.RatedMovie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder setReleaseYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder clearReleaseYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.RatedMovie.Builder clearRating() {
