...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2761607603752618573L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"release_year\",\"type\":\"int\"}]}");
   ...
   */
  public static org.example.avro.Movie.Builder newBuilder() {
    return new org.example.avro.Movie.Builder();
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static org.example.avro.Movie.Builder newBuilder(org.example.avro.Movie.Builder other) {
    if (other == null) {
      return new org.example.avro.Movie.Builder();
    } else {
      return new org.example.avro.Movie.Builder(other);
    }
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static org.example.avro.Movie.Builder newBuilder(org.example.avro.Movie other) {
    if (other == null) {
      return new org.example.avro.Movie.Builder();
    } else {
      return new org.example.avro.Movie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Movie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Movie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Movie.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Movie.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Movie.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Movie.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Movie.Builder setReleaseYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Movie.Builder clearReleaseYear() {
