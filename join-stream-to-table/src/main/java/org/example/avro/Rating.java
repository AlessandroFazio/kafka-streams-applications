...
public class Rating extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3164148632963729305L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Rating\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"rating\",\"type\":\"double\"}]}");
   ...
   */
  public static org.example.avro.Rating.Builder newBuilder() {
    return new org.example.avro.Rating.Builder();
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static org.example.avro.Rating.Builder newBuilder(org.example.avro.Rating.Builder other) {
    if (other == null) {
      return new org.example.avro.Rating.Builder();
    } else {
      return new org.example.avro.Rating.Builder(other);
    }
  }
   ...
   * @return A new Rating RecordBuilder
   */
  public static org.example.avro.Rating.Builder newBuilder(org.example.avro.Rating other) {
    if (other == null) {
      return new org.example.avro.Rating.Builder();
    } else {
      return new org.example.avro.Rating.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rating>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Rating.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Rating other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Rating.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Rating.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Rating.Builder setRating(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Rating.Builder clearRating() {
